;; Awesome Colour Theme
;; Based on Cyberpunk Colour Theme
...
(defun color-theme-awesome ()
  ...
  (color-theme-install
   '(color-theme-awesome
     ...
     (gui-element ((t (:background "black" :foreground "#96CBFE"))))
;;     (region ((t (:foreground "black" :background "#7F073F"))))
     (region ((t ( :background "#7F073F"))))
     (mode-line ((t (:background "black" :foreground "#4cfff0"))))
     ...
     (query-replace ((t (:background "black"))))
     ...
     (vertical-border ((t (:background "gray10" :foreground "black"))))
...
;;     (erc-command-indicator-face ((t (:bold t :weight bold))))
     ...
     (git-gutter:deleted ((t (:foreground "black" :background "gray5"))) )
